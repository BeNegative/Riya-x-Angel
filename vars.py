...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "GOOGLExBABA")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "7517872227"))
ADMINS = [7517872227, 1339834016]  # dono admins id list me
